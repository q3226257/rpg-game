...
DataManager.processHENote = function (group, type) {
    for (var n = 1; n < group.length; n++) {
        RJO.HE.getDescParams(group[n], type);
    }
};
...
RJO.HE.normalcolor = function (item) {
    return RJO.HE.ItemDescNormalColor;
}
RJO.HE.namecolor = function (item) {
    return RJO.HE.ItemDescNameColor;
}
...
RJO.HE.getEquipBaseDescParams = function (item, normalcolor) {
    ...
    for (var i = 0; i < item.params.length; i++) {
        value = item.params[i];
        if (value != 0) {
            item.descParams.push([TextManager.param(i) + ":" + value, RJO.HE.ItemDescOtherSize, paramscolor[i], false]);
        }
    }
...
Sprite_ItemHelp.prototype.standardLineColor = function () {
    return RJO.HE.ItemDescLineColor;
};
Sprite_ItemHelp.prototype.standardPadding = function () {
    return 4;
};
Sprite_ItemHelp.prototype.contentsWidth = function () {
    return this.width - 2 * this.standardPadding();
};
Sprite_ItemHelp.prototype.contentsHeight = function () {
    return Math.max(this.height - 2 * this.standardPadding(), 1);
};
...
Sprite_ItemHelp.prototype.hide = function () {
    this.visible = false;
}
Sprite_ItemHelp.prototype.show = function () {
    this.visible = true;
}
...
// var system_createItemWindow = Scene_Item.prototype.createItemWindow
// Scene_Item.prototype.createItemWindow = function () {
//     system_createItemWindow.call(this);
...
// var system_createCommandWindow = Scene_Shop.prototype.createCommandWindow;
// Scene_Shop.prototype.createCommandWindow = function () {
//     system_createCommandWindow.call(this);
//
